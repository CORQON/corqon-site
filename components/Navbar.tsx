...
export default function Navbar() {
  ...
  // Mobile: Simple static navbar, no animations, no complex state
  if (isMobile) {
    return (
      <>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <Link 
                  ...
                  className="px-3 py-1.5 bg-white/10 text-white rounded-full text-xs font-medium whitespace-nowrap"
        ...
        {isMobileMenuOpen && (
          <>
            <div
              ...
              aria-hidden="true"
            />
            <div className="fixed top-[52px] left-0 right-0 z-50 bg-black border-b border-white/10">
              <div className="max-w-7xl mx-auto px-4 py-4">
                <nav className="flex flex-col space-y-3">
                  <a
                    href="#datastreams"
                    className="text-white/80 hover:text-white text-base py-2"
                    onClick={closeMobileMenu}
                  >
                    Datastreams
                  </a>
